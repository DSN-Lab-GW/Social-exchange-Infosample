...
load estimates_DDMcollapse_TD.mat;
pars_est(:,1) = [];
...
for subjidx = 1:length(pars_est)
    ...
    trialNr = 1;
        ...
        bound   = pars_est(subjidx, 2);
        collapse_est   = pars_est(subjidx, 3);
m   = 2;
T = 25;
        DeltaQ = computeDDM_collapse_ORA(T, m, bound, collapse_est);
...
save generated_DDMcollapse_modelRecovery_ORA_03Dec2022 data