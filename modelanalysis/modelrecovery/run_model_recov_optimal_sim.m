...
% save('/CCAS/home/wenda_liu/optimal_uncer.mat','pars_est_uncertainty','allbestNLL_uncertainty')
save('optimal_uncer.mat','pars_est_uncertainty','allbestNLL_uncertainty');
...
% save('/CCAS/home/wenda_liu/optimal_threC.mat','pars_est_thresholdC','allbestNLL_thresholdC')
save('optimal_threC.mat','pars_est_thresholdC','allbestNLL_thresholdC');
...
% save('/CCAS/home/wenda_liu/optimal_optimal.mat','pars_est_optimal','allbestNLL_optimal')
save('optimal_optimal.mat','pars_est_optimal','allbestNLL_optimal');
...
%     optimalBIC  = (log(dpssym{num_ite}(:,2)))*6 - (2* -optimalNLL);
    ...
    All_AIC = [uncertAIC countAIC];
    All_BIC = [uncertBIC countBIC];
...
% save('/CCAS/home/wenda_liu/Optimal_sim_recov_BIC.mat','freq_win','All_BIC','All_AIC')
save('Optimal_sim_recov_BIC.mat','freq_win','All_BIC','All_AIC')
%%
