...
load estimate_optimal_TD_noprior;
...
for subjidx = 1:length(pars_est)
    ...
    trialNr = 1;
        ...
        %Estimates
        k_est     = pars_est(subjidx, 1);
        beta1_est = pars_est(subjidx, 2);
        c_est  = pars_est(subjidx, 3);
        risk        = pars_est(subjidx, 4);
        priorAlpha  = 1;
        priorBeta   = 1;
...
save generated_Optimalnoprior_modelRecovery_ORA_03Dec2022 data