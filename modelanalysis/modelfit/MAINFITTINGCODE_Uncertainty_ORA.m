...
%     highLimits = [inf 1];
    ...
    NLL;
    [~, bestrun] = min(NLL); 
    [fittedpars, bestNLL] = fmincon(myNLL, init(bestrun,:),[],[],[],[], lowLimits, highLimits, [], optimset('Display', 'on'));
...
% save estimates_uncertainty_ASD_noprior pars_est allbestNLL
save estimates_uncertainty_ASD_all pars_est allbestNLL
